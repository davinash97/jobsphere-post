...
public class ProfileServiceImpl implements ProfileService {
	...
	@Override
	public Profile create(String first_name, String last_name, String user_name, String account_type){
		try {
			// if(!queryExists(user_name)) return null;
	...
	@Override
	public Profile update(UUID id, String first_name, String last_name, String user_name, String account_type, Long phone, String email) {
