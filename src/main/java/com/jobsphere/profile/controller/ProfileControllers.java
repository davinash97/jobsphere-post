...
public class ProfileControllers {
	...
	private static final Logger log = LoggerFactory.getLogger(ProfileControllers.class);
	...
	public ResponseEntity<Response<?>> create(@RequestBody (required=false) Profile body,
		...
		try {
			...
			Profile profile = service.create(first_name, last_name, user_name, account_type);
